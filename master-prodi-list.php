														...
														foreach ($dataPelanggan as $index => $pelanggan){
															echo '<tr class="align-middle">
																...
																<td class="text-center">
																	...
																	<button type="button" class="btn btn-sm btn-danger" onclick="if(confirm(\'Yakin ingin menghapus data pelanggan ini?\')){window.location.href=\'proses/proses-pelanggan.php?aksi=deletepelanggan&id='.$pelanggan['id_pelanggan'].'\'}"><i class="bi bi-trash-fill"></i> Hapus</button>
																</td>
															</tr>';
														}
													}
